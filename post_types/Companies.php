...
class Companies extends WpAlgoliaRegisterAbstract implements WpAlgoliaRegisterInterface
{
    public $searchable_fields = array('post_title', 'content');

    public $acf_fields = array('link', 'link_to_permalink');

    public $taxonomies = array('sectors', 'regions', 'company_types', 'post_tag');
