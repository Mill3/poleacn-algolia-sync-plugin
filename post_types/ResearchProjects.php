...
class ResearchProjects extends WpAlgoliaRegisterAbstract implements WpAlgoliaRegisterInterface
{
    ...
    public $taxonomies = array('sectors', 'regions', 'research_project_types', 'research_types', 'post_tag');
    ...
    public function __construct($post_type, $index_name, $algolia_client)
    {
        $index_config = array(
            ...
            'config'            => array(
                ...
                'attributesForFaceting' => array('searchable(sectors)'),
