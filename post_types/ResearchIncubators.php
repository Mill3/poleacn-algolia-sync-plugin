...
class ResearchIncubators extends WpAlgoliaRegisterAbstract implements WpAlgoliaRegisterInterface
{
    ...
    public $taxonomies = array('sectors', 'incubator_types', 'regions', 'post_tag');
    ...
    public function __construct($post_type, $index_name, $algolia_client)
    {
        $index_config = array(
            ...
            'config'            => array(
                ...
                'attributesForFaceting' => array('searchable(sectors)', 'searchable(incubator_types)'),
